  ...
  new BurgerMenu(
    {
      ...
      HEADER_MENU: "header-main__menu", // Меню которое будет открываться
      HEADER_MENU_OPEN: "header-main__menu--open", // Модификатор на который будем получать меню справа (анимация)
      lABEL: {
